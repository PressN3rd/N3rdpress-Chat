(function() {
	...
	tinymce.create('tinymce.plugins.ChatPlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand('mceChat', function() {
				ed.windowManager.open({
					file : url + "../../../../../wp-admin/admin-ajax.php?action=chatTinymceOptions",
					width : 650 + ed.getLang('chat.delta_width', 0),
					height : 600 + ed.getLang('chat.delta_height', 0),
					inline : 1
				}, {
		...
		getInfo : function() {
			return {
				longname : 'WPMUDEV Chat plugin',
				author : 'Paul Menard',
				authorurl : 'http://premium.wpmudev.org/project/wordpress-chat-plugin',
				infourl : 'http://premium.wpmudev.org/project/wordpress-chat-plugin',
				version : "2.0"
			};
		}
	});
